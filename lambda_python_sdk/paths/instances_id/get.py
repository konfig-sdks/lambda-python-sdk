...
from lambda_python_sdk.model.instance_get_details_response import InstanceGetDetailsResponse as InstanceGetDetailsResponseSchema
...
from lambda_python_sdk.type.instance_get_details_response import InstanceGetDetailsResponse

from ...api_client import Dictionary
from lambda_python_sdk.pydantic.instance_get_details_response import InstanceGetDetailsResponse as InstanceGetDetailsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = InstanceGetDetailsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: InstanceGetDetailsResponse
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> InstanceGetDetailsResponsePydantic:
        raw_response = await self.raw.aget_details(
            id=id,
            **kwargs,
        )
        if validate:
            return InstanceGetDetailsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(InstanceGetDetailsResponsePydantic, raw_response.body)
