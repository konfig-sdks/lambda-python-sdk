...
from lambda_python_sdk.model.instance_type_get_list_response import InstanceTypeGetListResponse as InstanceTypeGetListResponseSchema
from lambda_python_sdk.model.error_response_body import ErrorResponseBody as ErrorResponseBodySchema

from lambda_python_sdk.type.instance_type_get_list_response import InstanceTypeGetListResponse
...
from lambda_python_sdk.pydantic.instance_type_get_list_response import InstanceTypeGetListResponse as InstanceTypeGetListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = InstanceTypeGetListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: InstanceTypeGetListResponse
...
class GetList(BaseApi):
    ...
    async def aget_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> InstanceTypeGetListResponsePydantic:
        raw_response = await self.raw.aget_list(
            **kwargs,
        )
        if validate:
            return InstanceTypeGetListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(InstanceTypeGetListResponsePydantic, raw_response.body)
